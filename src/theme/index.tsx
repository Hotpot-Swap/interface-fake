...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bgFooter: darkMode ? "rgba(24, 26, 31, 0.38)" : "rgba(255, 255, 255, 0.7)",
    bgFooter: darkMode ? "#181A1F" : "#fff",
    ...
    bgrFlex: darkMode ? "#181A1F" : "#FFFFFF",
    titleToken: darkMode
      ? "rgba(255, 255, 255, 0.87)"
      : "rgba(0, 28, 78, 0.87)",
...
export const ThemedGlobalStyle = createGlobalStyle`
  ...
  header .wrap-header{
    ...
    box-shadow: 0px 1px 1px ${({ theme }) => theme.boxShadow};
    position: fixed;
    width: 100%;
    z-index: 9999;
    ...
    .bg-fixed {
      ...
      @media(max-width: 767px){
        button,.text-language,.text-color{
          font-size: 12px;
        }
      }
    }
  ...
  .btn-secondary {
    background: rgba(87, 115, 231, 0.1);
