...
export default function CurrencyInputPanel({
  ...
  const getPriceInput = async () => {
    if ((currency as any)?.address) {
      ...
      const valueUSDC = value && value !=='.' && Number(value) != Infinity && Number(value) != NaN? (Number(value) * Number(price)).toFixed(2) : '0.00';
        ...
        <>
          ...
          <div className="flex items-center w-full space-x-3 rounded input-col">
            <div className="flex flex-col justify-end">
              ...
              <div
                data-tip={value && value.length > 0 ? value : "0.0"}
            ...
            {!hideInput && (
              <>
                ...
                {account ? (
                  ...
                  <>
                    <div data-tip={value && value.length > 0 ? value : "0.0"}
                      data-tip-disable={false}
                      data-for={id + "tooltip"}
                      data-iscapture='true'
                      >
