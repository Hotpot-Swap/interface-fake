...
const TabExchange = styled.div<({isLimitOrder})>`
  border-bottom: 2px solid ${(props) => props.isLimitOrder ?  '#72BF65' : 'transparent'};
`
  ...
  return (
    <div className="flex justify-between mb-4 space-x-3">
      <div className="flex space-x-3 rounded-md p-3px gap-8">
        ...
        >
          <TitleExchange className="flex items-center justify-center font-semibold text-center rounded-md " onClick={isLimitOrder ? onChangeSwapTab : () => {}}>
            {i18n._(t`Swap`)}
          </TitleExchange>
        </TabExchange>
        <TabExchange
