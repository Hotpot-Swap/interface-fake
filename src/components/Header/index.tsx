...
function AppBar({ setShowMenu, isShowMenu }): JSX.Element {
            ...
            >
              ...
              >
                <StyleDiv className="flex items-center justify-between w-full sm:space-x-2 sm:justify-end container">
                  ...
                  <div
                    className="w-auto flex items-center rounded whitespace-nowrap cursor-pointer select-none pointer-events-auto btn-primary2"
